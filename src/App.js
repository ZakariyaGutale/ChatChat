...
function App() {
  ...
  return (
    <div className="App">
      <header>
        <svg className='logo' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6" color='#111827'>
